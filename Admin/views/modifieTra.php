   ...
   try {
    ...
    <?php
           foreach($qtm as $r){
            ...
            <form method="POST" action="changeTra">
            <div class="row">
                    
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="bmd-label-floating">id</label>
                        <input type="text" name="id" id="nom" class="form-control" value="  <?php echo $r["id"];  ?>  " disable/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nom" id="nom" class="form-control" value="  <?php echo $r["nom"];  ?>  "/>
